...
def CheckforOvertime(totalWorkingHrs):
    if totalWorkingHrs < 40:
        normalHrs = totalWorkingHrs
        
    elif totalWorkingHrs > 40:
...
def WeeklyPaymentCalculator():
    try:
        ...
        totalWorkingHrs = int(totalWorkingHrs)
        if totalWorkingHrs in range(1, 40):
            normalHrs = totalWorkingHrs
            overtimeHrs = 0
        elif totalWorkingHrs in range (40, 100):
            overtimeHrs = totalWorkingHrs - 40
            normalHrs = 40
        else:
