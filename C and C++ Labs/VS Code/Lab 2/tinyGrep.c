...
Task Description:
    ...
    The following table shows some examples.
        ...
        | "Hello," said the cat.  | ,       | N              | Matches at position 0.  |
        --------------------------------------------------------------------------------
...
int findPattern(const char *inputPattern, const char *inputText, int caseSensitive)
{
    ...
    for (int textIndex = 0; textIndex <= (textLength - patternLength); textIndex++)
    {
        ...
        for (int patternIndex = 0; patternIndex < patternLength; patternIndex++)
        {
            ...
            if (!caseSensitive) // Check if case sensitivity is to be applied or not
            {
...
int main()
{
    ...
    // caseSensitive = 1 (true) if 'Y' and caseSensitive = 0 (false) if 'N'
    caseSensitive = toupper(caseSensitive);

    matchedPattern = findPattern(inputPattern, inputText, caseSensitive);
